...
void loop()
{
  ...
  //  if (startIndex >= NUM_LEDS * 100) {
  //    startIndex = 0;
  //  }
  //  oneAtTime( startIndex / 100);
...
void oneAtTime( uint8_t colorIndex)
{
  ...
  //leds[colorIndex] += CHSV(colorIndex / 10  , 255, 64);

  leds[colorIndex] += CRGB(0, 64, 0);


}


// There are several differen`t palettes of colors demonstrated here.
//
